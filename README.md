...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hxp8kga.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hxp8kga.containers.anotherwebservice.com/
...
```
git clone git@github.com:geneross/container-hxp8kga.git
cd container-hxp8kga
```
...
```
docker attach container-hxp8kga
```
